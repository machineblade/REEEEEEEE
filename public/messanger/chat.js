...
// Load env from backend (which uses process.env)
...
// Get current auth user and username from your public.users table
...
// Contacts in localStorage based on username
...
async function sendMessage(content) {
  if (!currentUser || !currentChat || !content.trim()) {
    return;
  }
